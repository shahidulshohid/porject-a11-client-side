    ...
    <div className="pb-12">
      <footer className="footer bg-green-300 text-neutral-content p-10">
        ...
        <nav>
          ...
          <p className="flex items-center gap-3 text-gray-500"><FaSquarePhoneFlip size={20}/> <small className="text-xl font-bold text-gray-500">555 624 862</small></p>
          <p className="flex items-center gap- text-gray-500"><MdEmail size={20}/> <small className="text-xl font-bold text-gray-500">555 624 862</small></p>
        </nav>
      </footer>
    </div>
  );
